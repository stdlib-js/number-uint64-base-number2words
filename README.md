...
```javascript
import number2words from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint64-base-number2words@esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { assign } from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint64-base-number2words@esm/index.mjs';
```
